...
const Movie = () => {
  ...
  const handleEdit = (event) => {
    ...
    setInput({title: dataMovie.title, rating: dataMovie.rating, genre: dataMovie.genre, duration: dataMovie.duration, year: dataMovie.year, description: dataMovie.description})
